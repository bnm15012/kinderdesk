...
function Signup() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* ── Right: Form panel ── */}
      <div className="flex-1 flex flex-col lg:flex-none lg:items-start lg:justify-center lg:bg-slate-50 max-lg:bg-[radial-gradient(ellipse_at_top_left,_#6366f1_0%,_#3b82f6_35%,_#0ea5e9_65%,_#06b6d4_100%)] overflow-y-auto overflow-x-hidden relative">
        ...
        <div className="lg:hidden absolute bottom-0 right-8 w-64 h-64 rounded-full bg-indigo-600/50 blur-3xl pointer-events-none" />
