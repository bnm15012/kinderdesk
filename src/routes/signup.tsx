...
function Signup() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* ── Right: Form panel ── */}
      <div className="flex-1 flex items-start justify-center lg:bg-slate-50 bg-[radial-gradient(ellipse_at_top_left,_#6366f1_0%,_#3b82f6_35%,_#0ea5e9_65%,_#06b6d4_100%)] px-6 py-10 overflow-y-auto overflow-x-hidden relative">
